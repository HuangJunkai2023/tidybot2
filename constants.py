...
UARM_MAX_JOINT_SPEED_DEG = np.array([25.0, 25.0, 25.0, 40.0, 40.0, 40.0, 40.0], dtype=np.float64)
UARM_MAX_JOINT_ACCEL_DEG = np.array([100.0, 100.0, 100.0, 160.0, 160.0, 160.0, 160.0], dtype=np.float64)
...
UARM_RT_READ_TIMEOUT_US = 30000
UARM_RT_COMMAND_DELAY_US = 8000
UARM_RT_STALE_TIMEOUT = 0.30
UARM_RT_FILTER_FREQ = 8.0
UARM_RT_SERVOJ_KP = 1.0
UARM_RT_DEADBAND_DEG = 0.0
UARM_RT_STEP_DEADBAND_DEG = 1.0
UARM_RT_FILTER_ALPHA = 0.2
UARM_RT_INTERP_STEPS = 5
UARM_RT_INTERP_HZ = 50.0
UARM_RT_ROBOT_TARGET_FILTER_HZ = 3.0
UARM_RT_ROBOT_TARGET_DEADBAND_DEG = 0.8
