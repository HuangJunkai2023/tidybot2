...
UARM_MAX_JOINT_SPEED_DEG = np.array([35.0, 35.0, 35.0, 50.0, 50.0, 50.0, 50.0], dtype=np.float64)
...
UARM_RT_FILTER_FREQ = 20.0
UARM_RT_SERVOJ_KP = 1.0
UARM_RT_DEADBAND_DEG = 0.8
UARM_RT_FILTER_ALPHA = 0.15
