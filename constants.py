...
ER3PRO_CPP_BRIDGE_BIN = '../xCoreSDK_cpp-v0.6.0/build/bin/arm_bridge'
ER3PRO_RT_FILTER_FREQ = 12.0
ER3PRO_RT_NETWORK_TOLERANCE = 40.0
ER3PRO_RT_MAX_LIN_SPEED = 0.12      # m/s
ER3PRO_RT_MAX_ANG_SPEED = 0.8       # rad/s
ER3PRO_RT_POS_DEADBAND = 0.0015     # m
ER3PRO_RT_ROT_DEADBAND = 0.02       # rad
