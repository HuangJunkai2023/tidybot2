...
UARM_MAX_JOINT_SPEED_DEG = np.array([55.0, 55.0, 55.0, 75.0, 75.0, 75.0, 75.0], dtype=np.float64)
...
UARM_RT_FILTER_FREQ = 15.0
UARM_RT_SERVOJ_KP = 1.0
UARM_RT_DEADBAND_DEG = 0.35
UARM_RT_STEP_DEADBAND_DEG = 0.6
UARM_RT_FILTER_ALPHA = 0.16
