...
UARM_MAX_JOINT_SPEED_DEG = np.array([12.0, 12.0, 12.0, 18.0, 18.0, 18.0, 18.0], dtype=np.float64)
...
UARM_RT_FILTER_FREQ = 10.0
UARM_RT_SERVOJ_KP = 1.0
UARM_RT_DEADBAND_DEG = 1.0
UARM_RT_STEP_DEADBAND_DEG = 1.2
UARM_RT_FILTER_ALPHA = 0.05
