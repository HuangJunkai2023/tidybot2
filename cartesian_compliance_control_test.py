...
def main():
    parser = argparse.ArgumentParser(
        description='Hold ER3Pro at the preset pose under cartesian impedance control.'
    )
    ...
    try:
        ...
        print('Holding still with cartesian impedance control. Push the TCP gently to test compliance.')
        ...
        while time.monotonic() - start < args.duration:
            ...
            if now >= next_print:
                ...
                print(
                    ...
                    f'joints={np.round(np.rad2deg(state["arm_joints"]), 2).tolist()} '
